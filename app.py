...
# verification page call in app.py
...
if st.session_state["authentication_status"]:
    ...
    selected_prompt_name = st.sidebar.selectbox("Select System Instruction Prompt", prompt_names,
                                                index=prompt_names.index("Assistant"))
